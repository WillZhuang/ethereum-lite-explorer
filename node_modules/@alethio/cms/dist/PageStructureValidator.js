export class PageStructureValidator {
    validate(pages) {
        ...
        pages.forEach((page, i) => {
            ...
            let [valid, err] = this.validateChildrenObject(page.children);
            if (!valid) {
                throw new Error(`"pages[${i}]" is invalid. ${err}`);
            }
        });
    }
    validateModuleMap(modules) {
    ...
    validateChildrenObject(children) {
    ...
    validateChildrenArray(children) {
    ...
    validateModule(mod) {
        ...
        if (mod.children) {
            let [valid, err] = this.validateChildrenObject(mod.children);
            if (!valid) {
    ...
    validateContext(context) {
        ...
        let [valid, err] = this.validateChildrenArray(context.children);
        if (!valid) {
...
//# sourceMappingURL=PageStructureValidator.js.map