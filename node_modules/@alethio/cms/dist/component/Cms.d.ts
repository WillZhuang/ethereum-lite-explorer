...
import { IRootPageProps } from "./PageRenderer";
...
export declare class Cms<TRootSlotType extends string> extends React.Component<ICmsProps<TRootSlotType>> {
    private loadStatus;
    private cmsRendererConfig;
