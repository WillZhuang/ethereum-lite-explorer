...
export class ProductIconButton extends React.Component {
    render() {
        return (React.createElement(HoverState, null, (hover) => React.createElement(IconButton, { Icon: this.props.Icon, color: hover ? void 0 : theme => theme.colors.toolbarIcon, iconSize: 24 })));
    }
}
