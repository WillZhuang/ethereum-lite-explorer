...
const Layer = styled.div.withConfig({ displayName: "Layer", componentId: "sc-1azzjuz" }) `
    position: fixed;
    top: 0;
    left: 0;
    bottom: 0;
    right: 0;
`;
const Content = styled.div.withConfig({ displayName: "Content", componentId: "sc-1hudjme" }) `
    display: flex;
...
MobileMenuLayer = tslib_1.__decorate([
    observer
], MobileMenuLayer);
