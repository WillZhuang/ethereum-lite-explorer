...
export declare const Box: import("styled-components").StyledComponentClass<IBoxProps, ITheme, Pick<IBoxProps, "className" | "colors" | "Icon" | "iconPlacement" | "metrics" | "fullWidth"> & {
