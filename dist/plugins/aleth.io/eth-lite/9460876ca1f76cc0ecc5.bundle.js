...
`;class L extends s["Component"]{render(){return s["createElement"](y,null,s["createElement"]("div",{style:{padding:"4px"}},s["createElement"](w,{onClick:this.props.onClose},s["createElement"](E,null))),this.props.children)}}const k=n["b"].div.withConfig({displayName:"Overlay",componentId:"sc-12wc7lq"})`
    position: fixed;
    top: 0;
    bottom: 0;
    left: 0;
    right: 0;
`;let M=class e extends s["Component"]{constructor(){super(...arguments);this.isOpened=!1;this.openSelectBox=(()=>{this.isOpened=!0});this.closeSelectBox=(()=>{this.isOpened=!1})}render(){let{disabled:e}=this.props;return s["createElement"](f["c"],null,s["createElement"](x["a"],null,({ref:t})=>s["createElement"]("div",{ref:t,onClick:e?void 0:this.openSelectBox,style:{cursor:e?"default":"pointer"}},this.props.children)),this.isOpened?v["createPortal"](s["createElement"](s["Fragment"],null,s["createElement"](k,{onClick:this.closeSelectBox}),s["createElement"](C["a"],{modifiers:{offset:{offset:this.props.offset?this.props.offset.left+"px, "+this.props.offset.top+"px":"auto"},flip:{enabled:!1},preventOverflow:{enabled:!0},hide:{enabled:!1}},placement:"bottom-start"},({ref:e,placement:t,style:r})=>s["createElement"]("div",{ref:e,"data-placement":t,style:r},s["createElement"](L,{onClose:this.closeSelectBox},this.props.render({requestClose:this.closeSelectBox}))))),document.body):null)}};o["b"]([l["observable"]],M.prototype,"isOpened",void 0);M=o["b"]([i["observer"]],M);class S extends s["Component"]{render(){return s["createElement"](c["a"],Object.assign({},this.props),s["createElement"]("g",{stroke:"none",strokeWidth:"1",fill:"none",fillRule:"evenodd"},s["createElement"]("polygon",{points:"0 0 24 0 24 24 0 24"}),s["createElement"]("path",{d:"M19,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,5 C21,3.9 20.1,3 19,3 Z M17,13 L13,13 L13,17 L11,17 L11,13 L7,13 L7,11 L11,11 L11,7 L13,7 L13,11 L17,11 L17,13 Z",fill:"currentColor",fillRule:"nonzero"})))}}const O=n["b"].div.withConfig({displayName:"ColumnSelectorIconWrapper",componentId:"sc-16xhwo1"})`
    color: ${({theme:e})=>e.colors.gridColumnSelector};
`;class T extends s["PureComponent"]{constructor(){super(...arguments);this.onCheckboxChange=((e,t,r,o)=>{this.props.onChange(r,t)})}render(){let e=this.props.fields.filter(e=>!e.alwaysVisible);if(0===e.length)return null;return s["createElement"]("div",{style:{padding:"4px"}},s["createElement"](M,{offset:{left:-21,top:-45},render:()=>e.map(e=>s["createElement"](b,{id:"column_"+e.fieldKey,key:e.fieldKey,name:e.fieldKey,value:e.fieldKey,checked:e.selected,onChange:this.onCheckboxChange},e.label))},s["createElement"](O,null,s["createElement"](S,null))))}}const R=n["b"].div.withConfig({displayName:"HeaderSpacer",componentId:"sc-dfupy1"})`
    border-bottom: 1px solid ${e=>e.theme.colors.gridBorder};
    background-color: ${e=>e.theme.colors.gridEvenRowBg};
    display: flex;
`;const $=Object(n["b"])(R).withConfig({displayName:"HeaderSpacerLeft",componentId:"sc-12qtzeq"})``;const F=Object(n["b"])(R).withConfig({displayName:"HeaderSpacerRight",componentId:"sc-1r6mde"})`
    justify-content: flex-end;
`;const V=n["b"].div.withConfig({displayName:"HeaderVertBorder",componentId:"sc-h0ci2y"})`
    background-color: ${e=>e.theme.colors.gridBorder};
    height: 100%;
    align-self: end;
`;class B extends s["PureComponent"]{render(){const e=s["Children"].toArray(this.props.children);const t=e.reduce((t,r,o)=>{t.push(s["createElement"]("span",{key:-o-1},r));o!==e.length-1&&t.push(s["createElement"](V,{key:o+1}));return t},[s["createElement"]($,{key:0},s["createElement"](T,{onChange:(e,t)=>{this.props.onFieldsChange(e,t)},fields:this.props.fields}),this.props.extraElements&&this.props.extraElements.left)]);t.push(s["createElement"](F,{key:e.length+1},this.props.extraElements&&this.props.extraElements.right));return t}}const z=32;const H=8;const D=Object(n["b"])("div").withConfig({displayName:"Spacer",componentId:"sc-1ry8zd3"})`
    background-color: ${({odd:e,theme:t})=>e?t.colors.gridOddRowBg:t.colors.gridEvenRowBg};
`;const I=Object(n["b"])("div").withConfig({displayName:"Item",componentId:"sc-t1lpom"})`
    padding: ${8}px ${32}px;
    background-color: ${({odd:e,theme:t})=>e?t.colors.gridOddRowBg:t.colors.gridEvenRowBg};
`;const N=n["b"].div.withConfig({displayName:"VertBorder",componentId:"sc-1dxy4m"})`
    background-color: ${e=>e.theme.colors.gridBorder};
`;class A extends s["PureComponent"]{render(){const e=s["Children"].toArray(this.props.children);const t=e.reduce((t,r,o)=>{t.push(s["createElement"](I,{odd:this.props.odd,key:-o-1},r));o!==e.length-1&&t.push(s["createElement"](N,{key:o+1}));return t},[s["createElement"](D,{odd:this.props.odd,key:0})]);t.push(s["createElement"](D,{odd:this.props.odd,key:e.length+1}));return t}}var j=r("C4qQ");const G=n["b"].div.withConfig({displayName:"GridHeaderHitBox",componentId:"sc-1t9uvnh"})`
`;const _=Object(n["b"])("div").withConfig({displayName:"HeaderItem",componentId:"sc-15pjbl0"})`
    ...
    `}
`;const Z=n["b"].div.withConfig({displayName:"ArrowDown",componentId:"sc-1dcuvx9"})`
...
`;const W=n["b"].div.withConfig({displayName:"ArrowUp",componentId:"sc-pmevxn"})`
...
`;const q=n["b"].div.withConfig({displayName:"NoArrow",componentId:"sc-1o7zin9"})`
    width: 24px;
`;let P=class e extends s["Component"]{constructor(){super(...arguments);this.onClick=(()=>{this.props.onClick&&this.props.onClick(this.props.field)})}render(){return s["createElement"](G,null,s["createElement"](_,{onClick:this.onClick,isSortable:this.props.field.isSortable},s["createElement"](j["a"],null,this.props.children),this.getHeaderSortArrow()))}getHeaderSortArrow(){if(!this.props.sortingOptions||this.props.sortingOptions.field!==this.props.field)return s["createElement"](q,null);if(this.props.sortingOptions.order===d["a"].Ascending)return s["createElement"](W,null);if(this.props.sortingOptions.order===d["a"].Descending)return s["createElement"](Z,null);return s["createElement"](q,null)}};P=o["b"]([i["observer"]],P);const K=n["b"].div.withConfig({displayName:"Wrapper",componentId:"sc-1329wqe"})`
    border-top: 1px solid ${e=>e.theme.colors.gridBorder};
    border-bottom: 1px solid ${e=>e.theme.colors.gridBorder};
`;const U=({children:e})=>s["createElement"](K,null,e);const Q=Object(n["b"])("div").withConfig({displayName:"GridData",componentId:"sc-1k2qfqp"})`
    height: 100%;
    display: flex;
    align-items: center;
    justify-content: ${({dataType:e})=>"number"===e?"flex-end":"auto"};
`;r.d(t,"a",function(){return X});const Y=n["b"].div.withConfig({displayName:"LoadMoreRows",componentId:"sc-1y1ghry"})`
    text-align: center;
    font-size: 14px;
    font-weight: 500;
    padding: 8px;
    cursor: pointer;
`;const J=n["b"].div.withConfig({displayName:"NoRowsAvailable",componentId:"sc-era9me"})`
    text-align: center;
    font-size: 14px;
    font-weight: 500;
    padding: 8px;
`;let X=class e extends s["Component"]{constructor(e){super(e);this.dataItemRenderer=((e,t)=>{if(e.renderer)return s["createElement"](Q,{key:e.fieldKey,dataType:e.type},"function"==typeof e.renderer?e.renderer(t.data):e.renderer.render(t.data));let r=e.getFieldValue(t.data).toString();return s["createElement"](Q,{key:e.fieldKey,dataType:e.type},r)});this.changeSorting=(e=>{this.props.sortingOptions.field!==e?this.props.sortingOptions.setAscendingOrder():this.props.sortingOptions.setNextOrder();void 0!==e&&(this.props.sortingOptions.field=e)});this.setColumnSelect=((e,t)=>{this.props.fields.setColumnSelect(e,t)});this.loadMoreRows=(()=>{this.visibleRows<this.props.rows.length&&(this.visibleRows+=50)});this.updateVisibleRows()}componentDidUpdate(e){this.props.limitRows===e.limitRows&&this.props.maxVisibleRows===e.maxVisibleRows||this.updateVisibleRows()}updateVisibleRows(){this.visibleRows=this.props.limitRows?this.props.maxVisibleRows:Number.POSITIVE_INFINITY}render(){const e=this.getSortedRows();return s["createElement"](s["Fragment"],null,s["createElement"](U,null,s["createElement"](a,{numberOfFields:this.props.fields.selectedGridFields.length},s["createElement"](B,{onFieldsChange:this.setColumnSelect,fields:this.props.fields.gridFields,extraElements:this.props.extraHeaderElements},this.props.fields.selectedGridFields.map(e=>s["createElement"](P,{key:e.fieldKey,field:e,onClick:e.isSortable?this.changeSorting:void 0,sortingOptions:this.props.sortingOptions},e.label))),e.slice(0,this.visibleRows).map((e,t)=>s["createElement"](A,{odd:!(t%2),key:e.key},this.props.fields.selectedGridFields.map(t=>this.dataItemRenderer(t,e)))))),this.visibleRows<this.props.rows.length?s["createElement"](Y,{onClick:this.loadMoreRows},this.props.loadMoreText):null,0===this.props.rows.length?s["createElement"](J,null,this.props.noDataText):null)}getSortedRows(){const e=this.props.sortingOptions;if(void 0===e.field||e.order===d["a"].Default)return this.props.rows;return[...this.props.rows].sort((t,r)=>{if(void 0===e.field||e.order===d["a"].Default)return-1;const o=e.field.getFieldValue(t.data);const s=e.field.getFieldValue(r.data);const n="string"!=typeof o&&"number"!=typeof o?o.comparedTo(s):this.defaultComparator(o,s);return e.order===d["a"].Ascending?n:-1*n})}defaultComparator(e,t){if(e===t)return 0;if(e<t)return-1;return 1}};X.defaultProps={maxVisibleRows:50,limitRows:!0};o["b"]([l["observable"]],X.prototype,"visibleRows",void 0);X=o["b"]([i["observer"]],X)}}]);
//# sourceMappingURL=9460876ca1f76cc0ecc5.bundle.js.map